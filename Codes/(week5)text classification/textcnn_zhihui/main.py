...
rootpath.append()
import yutong_nlp.textcnn_zhihui.mydatasets_embed as mydatasets_embed
import yutong_nlp.textcnn_zhihui.train as train
from yutong_nlp.textcnn_zhihui.CNN_text1 import CNN_Text
# import models.CNN_text1
# import models.CNN_text2
# import models.CNN_text3
# import train
# import mydatasets
# from mydatasets_embed import *
...
def handle_args():
    ...
    # workflow
    parser.add_argument('-read-path', type=str, default='/home/lei/yzh/exp9',
                        help='the path to the labeled data')
    parser.add_argument('-pos-num', type=int, default=5000, help='the number of positive tweets [default: 5000]')
    parser.add_argument('-neg-num', type=int, default=5000, help='the number of negative tweets [default: 5000]')
    ...
    # parser.add_argument('--embedding_file', type=str, default="glove.twitter.27B.100d.txt",
    #                     help='glove or w2v')
    # parser.add_argument('--embedding_dir', type=str, default="/home/lei/yzh/exp9/word2vec/glove.twitter.27B.100d.txt",
    #                     help='embedding_dir')
...
if __name__ == "__main__":
    ...
    # dataset = mydatasets.My_datasets(args)
    # train_loader, validate_loader, test_loader, vocab_len = dataset.get_train_validate_test_loader()
    #
    # # set the random seed
    # torch.manual_seed(3)
    # torch.cuda.manual_seed_all(3)
    #
    # model = models.CNN_text.CNN_Text(vocab_len, args)
    # my_loss = train.My_loss()
    # weight = torch.Tensor([args.pos_num / 1000, args.neg_num / 1000]).cuda()
    ...
    # model = models.CNN_text3.CNN_Text(args, vocab_len, weights)
    # model = models.CNN.CNN(args, vocab_len, weights)
    my_loss = train.My_loss()
